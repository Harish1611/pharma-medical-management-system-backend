...
const createResource = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .send({ message: "New Resource created successfully!", resource });
  } catch (err) {
...
const updateResoruce = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .send({ message: "Resource Updated Successfully", resource });
  } catch (err) {
    return res.status(500).send({ error: err.message });
  }
};
...
const deleteResource = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .send({ message: "Resource Deleted Successfully", resource });
  } catch (err) {
    return res.status(500).send({ error: err.message });
  }
};
...
const resourceCount = async (req, res) => {
  try {
    ...
    console.error("Error in resourceCount:", err); 
    return res.status(500).send({ error: err.message });
  }
};
